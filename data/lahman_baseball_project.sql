...
strikeouts_and_homeruns_by_decade AS
				(SELECT SUM(so) AS total_strikeouts, SUM(HR) AS total_homeruns,
					CASE WHEN yearid >= 1920 AND yearid < 1930 THEN '1920 - 1929'
						 ...
						 WHEN yearid >= 2000 AND yearid < 2010 THEN '2000 - 2009'
						 WHEN yearid >= 2010 AND yearid < 2017 THEN '2010 - 2017'
					 		ELSE 'Before 1920' END AS homeruns_per_decade
			FROM batting
...
--subqueries
SELECT yearid AS year, MAX(w), wswin
FROM teams
...
--8.Using the attendance figures from the home games table, find the teams and parks which had the top 5 average attendance per game in 2016 (where average attendance is defined as total attendance divided by number of games). Only consider parks where there were at least 10 games played. Report the park name, team name, and average attendance. Repeat for the lowest 5 average attendance.
